 ...
 */
static unsigned int tis_base = -1;
...
slb_tis_init(void)
{
    ...
    slb_out_description("entered slb_tis_init", 0);
	...
	case 0x32031114:
            slb_out_description("TPM on Dell Optiplex 749 rev", id->rid);
            return TIS_INIT_OTHERS;
        case 0:
        case -1:
 ...
 */
int
slb_tis_transmit(unsigned char *buffer, unsigned write_count,
