...
typedef struct _IMAGE_OS2_HEADER {      // OS/2 .EXE header
  ...
  } __attribute__((packed)) IMAGE_OS2_HEADER, *PIMAGE_OS2_HEADER ;
...
typedef struct _IMAGE_VXD_HEADER {      // Windows VXD header
  ...
  } __attribute__((packed)) IMAGE_VXD_HEADER, *PIMAGE_VXD_HEADER ;
...
typedef struct _IMAGE_ROM_OPTIONAL_HEADER {
    ...
    DWORD  CprMask[4];
    DWORD  GpValue;
} __attribute__((packed)) IMAGE_ROM_OPTIONAL_HEADER, *PIMAGE_ROM_OPTIONAL_HEADER;
...
typedef struct _IMAGE_OPTIONAL_HEADER64 {
    ...
    DWORD       NumberOfRvaAndSizes;
    IMAGE_DATA_DIRECTORY DataDirectory[IMAGE_NUMBEROF_DIRECTORY_ENTRIES];
} __attribute__((packed)) IMAGE_OPTIONAL_HEADER64, *PIMAGE_OPTIONAL_HEADER64;
...
} __attribute__((packed)) IMAGE_NT_HEADERS64, *PIMAGE_NT_HEADERS64;
...
} __attribute__((packed)) IMAGE_ROM_HEADERS, *PIMAGE_ROM_HEADERS;
...
} __attribute__((packed)) ANON_OBJECT_HEADER;
...
} __attribute__((packed)) ANON_OBJECT_HEADER_V2;
//
...
} __attribute__((packed)) IMAGE_AUX_SYMBOL;
...
} __attribute__((packed)) IMAGE_AUX_SYMBOL_TOKEN_DEF;
...
typedef struct _IMAGE_RELOCATION {
    ...
    DWORD   SymbolTableIndex;
    WORD    Type;
} __attribute__((packed)) IMAGE_RELOCATION;
...
} __attribute__((packed)) IMAGE_LINENUMBER;
...
} __attribute__((packed)) IMAGE_ARCHIVE_MEMBER_HEADER, *PIMAGE_ARCHIVE_MEMBER_HEADER;
...
} __attribute__((packed)) IMAGE_THUNK_DATA32;
...
typedef struct _IMAGE_TLS_DIRECTORY64 {
    ...
    DWORD   Characteristics;
} __attribute__((packed)) IMAGE_TLS_DIRECTORY64;
...
typedef struct _IMAGE_TLS_DIRECTORY32 {
    ...
    DWORD   SizeOfZeroFill;
     DWORD   Characteristics;
} __attribute__((packed)) IMAGE_TLS_DIRECTORY32;
...
} __attribute__((packed)) IMAGE_BOUND_IMPORT_DESCRIPTOR,  *PIMAGE_BOUND_IMPORT_DESCRIPTOR;

typedef struct _IMAGE_BOUND_FORWARDER_REF {
    DWORD   TimeDateStamp;
    WORD    OffsetModuleName;
    WORD    Reserved;
} __attribute__((packed)) IMAGE_BOUND_FORWARDER_REF, *PIMAGE_BOUND_FORWARDER_REF;
...
} __attribute__((packed)) IMAGE_RESOURCE_DIRECTORY, *PIMAGE_RESOURCE_DIRECTORY;
...
} __attribute__((packed)) IMAGE_RESOURCE_DIRECTORY_ENTRY, *PIMAGE_RESOURCE_DIRECTORY_ENTRY;
...
typedef struct _IMAGE_RESOURCE_DIRECTORY_STRING {
    WORD    Length;
    CHAR    NameString[ 1 ];
} __attribute__((packed)) IMAGE_RESOURCE_DIRECTORY_STRING, *PIMAGE_RESOURCE_DIRECTORY_STRING;


typedef struct _IMAGE_RESOURCE_DIR_STRING_U {
    WORD    Length;
    WCHAR   NameString[ 1 ];
} __attribute__((packed)) IMAGE_RESOURCE_DIR_STRING_U, *PIMAGE_RESOURCE_DIR_STRING_U;
...
typedef struct _IMAGE_RESOURCE_DATA_ENTRY {
    ...
    DWORD   CodePage;
    DWORD   Reserved;
} __attribute__((packed)) IMAGE_RESOURCE_DATA_ENTRY, *PIMAGE_RESOURCE_DATA_ENTRY;
...
} __attribute__((packed)) IMAGE_LOAD_CONFIG_DIRECTORY32, *PIMAGE_LOAD_CONFIG_DIRECTORY32;
...
} __attribute__((packed)) IMAGE_LOAD_CONFIG_DIRECTORY64, *PIMAGE_LOAD_CONFIG_DIRECTORY64;
...
} __attribute__((packed)) IMAGE_CE_RUNTIME_FUNCTION_ENTRY, * PIMAGE_CE_RUNTIME_FUNCTION_ENTRY;
...
} __attribute__((packed)) IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY, *PIMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;
...
} __attribute__((packed)) IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY, *PIMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY;

typedef struct _IMAGE_RUNTIME_FUNCTION_ENTRY {
    DWORD BeginAddress;
    DWORD EndAddress;
    DWORD UnwindInfoAddress;
} __attribute__((packed)) _IMAGE_RUNTIME_FUNCTION_ENTRY, *_PIMAGE_RUNTIME_FUNCTION_ENTRY;
...
typedef struct _IMAGE_DEBUG_DIRECTORY {
    ...
    DWORD   PointerToRawData;
} __attribute__((packed)) IMAGE_DEBUG_DIRECTORY, *PIMAGE_DEBUG_DIRECTORY;
...
} __attribute__((packed)) IMAGE_COFF_SYMBOLS_HEADER, *PIMAGE_COFF_SYMBOLS_HEADER;
...
} __attribute__((packed)) FPO_DATA, *PFPO_DATA;
...
} __attribute__((packed)) IMAGE_DEBUG_MISC, *PIMAGE_DEBUG_MISC;
...
typedef struct _IMAGE_FUNCTION_ENTRY {
    ...
    DWORD   EndingAddress;
    DWORD   EndOfPrologue;
} __attribute__((packed)) IMAGE_FUNCTION_ENTRY, *PIMAGE_FUNCTION_ENTRY;
...
} __attribute__((packed)) IMAGE_FUNCTION_ENTRY64, *PIMAGE_FUNCTION_ENTRY64;
...
typedef struct _IMAGE_SEPARATE_DEBUG_HEADER {
    ...
    DWORD       SectionAlignment;
    DWORD       Reserved[2];
} __attribute__((packed)) IMAGE_SEPARATE_DEBUG_HEADER, *PIMAGE_SEPARATE_DEBUG_HEADER;
...
} __attribute__((packed)) NON_PAGED_DEBUG_INFO, *PNON_PAGED_DEBUG_INFO;
...
} __attribute__((packed)) IMAGE_ARCHITECTURE_HEADER, *PIMAGE_ARCHITECTURE_HEADER;

typedef struct _ImageArchitectureEntry {
    DWORD FixupInstRVA;                         // RVA of instruction to fixup
    DWORD NewInst;                              // fixup instruction (see alphaops.h)
} __attribute__((packed)) IMAGE_ARCHITECTURE_ENTRY, *PIMAGE_ARCHITECTURE_ENTRY;
...
} __attribute__((packed)) IMPORT_OBJECT_HEADER;
...
} __attribute__((packed)) IMAGE_COR20_HEADER, *PIMAGE_COR20_HEADER;
