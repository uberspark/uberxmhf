...
// G6.2.100 ARMv8
//
#define LDESC_S1_MAIR_LO_DEVnGnRnE															0x0000b
#define LDESC_S1_MAIR_LO_DEVnGnRE															0x0100b
#define LDESC_S1_MAIR_LO_DEVnGRE															0x1000b
#define LDESC_S1_MAIR_LO_DEVGRE																0x1100b

#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITENOALLOCATE_INNER_WRITE_THROUGH_TRANSIENT		0x0000b
#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITEALLOCATE_INNER_WRITE_THROUGH_TRANSIENT			0x0001b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITENOALLOCATE_INNER_WRITE_THROUGH_TRANSIENT			0x0010b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITEALLOCATE_INNER_WRITE_THROUGH_TRANSIENT			0x0011b
#define LDESC_S1_MAIR_LO_INNER_NON_CACHEABLE												0x0100b
#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITEALLOCATE_INNER_WRITE_BACK_TRANSIENT			0x0101b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITENOALLOCATE_INNER_WRITE_BACK_TRANSIENT			0x0110b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITEALLOCATE_INNER_WRITE_BACK_TRANSIENT				0x0111b
#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITENOALLOCATE_INNER_WRITE_THROUGH_NONTRANSIENT	0x1000b
#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITEALLOCATE_INNER_WRITE_THROUGH_NONTRANSIENT		0x1001b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITENOALLOCATE_INNER_WRITE_THROUGH_NONTRANSIENT		0x1010b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITEALLOCATE_INNER_WRITE_THROUGH_NONTRANSIENT		0x1011b
#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITENOALLOCATE_INNER_WRITE_BACK_NONTRANSIENT		0x1100b
#define LDESC_S1_MAIR_LO_READNOALLOCATE_WRITEALLOCATE_INNER_WRITE_BACK_NONTRANSIENT			0x1101b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITENOALLOCATE_INNER_WRITE_BACK_NONTRANSIENT			0x1110b
#define LDESC_S1_MAIR_LO_READALLOCATE_WRITEALLOCATE_INNER_WRITE_BACK_NONTRANSIENT			0x1111b


#define LDESC_S1_MAIR_HI_DEV																0x0000b
#define LDESC_S1_MAIR_HI_READNOALLOCATE_WRITEALLOCATE_OUTER_WRITE_THROUGH_TRANSIENT			0x0001b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITENOALLOCATE_OUTER_WRITE_THROUGH_TRANSIENT			0x0010b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITEALLOCATE_OUTER_WRITE_THROUGH_TRANSIENT			0x0011b
#define LDESC_S1_MAIR_HI_OUTER_NON_CACHEABLE												0x0100b
#define LDESC_S1_MAIR_HI_READNOALLOCATE_WRITEALLOCATE_OUTER_WRITE_BACK_TRANSIENT			0x0101b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITENOALLOCATE_OUTER_WRITE_BACK_TRANSIENT			0x0110b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITEALLOCATE_OUTER_WRITE_BACK_TRANSIENT				0x0111b
#define LDESC_S1_MAIR_HI_READNOALLOCATE_WRITENOALLOCATE_OUTER_WRITE_THROUGH_NONTRANSIENT	0x1000b
#define LDESC_S1_MAIR_HI_READNOALLOCATE_WRITEALLOCATE_OUTER_WRITE_THROUGH_NONTRANSIENT		0x1001b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITENOALLOCATE_OUTER_WRITE_THROUGH_NONTRANSIENT		0x1010b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITEALLOCATE_OUTER_WRITE_THROUGH_NONTRANSIENT		0x1011b
#define LDESC_S1_MAIR_HI_READNOALLOCATE_WRITENOALLOCATE_OUTER_WRITE_BACK_NONTRANSIENT		0x1100b
#define LDESC_S1_MAIR_HI_READNOALLOCATE_WRITEALLOCATE_OUTER_WRITE_BACK_NONTRANSIENT			0x1101b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITENOALLOCATE_OUTER_WRITE_BACK_NONTRANSIENT			0x1110b
#define LDESC_S1_MAIR_HI_READALLOCATE_WRITEALLOCATE_OUTER_WRITE_BACK_NONTRANSIENT			0x1111b
