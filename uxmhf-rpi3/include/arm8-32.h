...
//
// stage-2 long descriptor memory cacheability for
// BLOCK and PAGE descriptors
// G4.7.5 ARMv8
//
#define LDESC_S2_MA_DEVnGnRnE														0x0
#define LDESC_S2_MA_DEVnGnRE														0x1
#define LDESC_S2_MA_DEVnGRE															0x2
#define LDESC_S2_MA_DEVGRE															0x3
#define LDESC_S2_MA_OUTER_NON_CACHEABLE_RESERVED 									0x4
#define LDESC_S2_MA_OUTER_NON_CACHEABLE_INNER_NON_CACHEABLE 						0x5
#define LDESC_S2_MA_OUTER_NON_CACHEABLE_INNER_WRITE_THROUGH_CACHEABLE 				0x6
#define LDESC_S2_MA_OUTER_NON_CACHEABLE_INNER_WRITE_BACK_CACHEABLE 					0x7
#define LDESC_S2_MA_OUTER_WRITE_THROUGH_CACHEABLE_RESERVED 							0x8
#define LDESC_S2_MA_OUTER_WRITE_THROUGH_CACHEABLE_INNER_NON_CACHEABLE 				0x9
#define LDESC_S2_MA_OUTER_WRITE_THROUGH_CACHEABLE_INNER_WRITE_THROUGH_CACHEABLE 	0xa
#define LDESC_S2_MA_OUTER_WRITE_THROUGH_CACHEABLE_INNER_WRITE_BACK_CACHEABLE 		0xb
#define LDESC_S2_MA_OUTER_WRITE_BACK_CACHEABLE_RESERVED 							0xc
#define LDESC_S2_MA_OUTER_WRITE_BACK_CACHEABLE_INNER_NON_CACHEABLE 					0xd
#define LDESC_S2_MA_OUTER_WRITE_BACK_CACHEABLE_INNER_WRITE_THROUGH_CACHEABLE 		0xe
#define LDESC_S2_MA_OUTER_WRITE_BACK_CACHEABLE_INNER_WRITE_BACK_CACHEABLE 			0xf
